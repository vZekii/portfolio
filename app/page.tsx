...
export default function Home() {
  ...
  return (
    <div className="mt-[--header-height] h-screen max-w-7xl m-auto">
      ...
      <div ref={projectsRef} id="projects" className="p-4 lg:p-10 scroll-m-10">
      ...
      <div ref={blogRef} id="blog" className="p-4 lg:p-10 scroll-m-10 h-screen">
        <h1 className="text-3xl font-mono pb-5 text-center dark:text-white">
          <a href="#Blog">Blog</a>
        </h1>
      </div>
      ...
      <div ref={contactRef} id="contact" className="p-4 lg:p-10 scroll-m-10 h-screen">
        <h1 className="text-3xl font-mono pb-5 text-center dark:text-white">
