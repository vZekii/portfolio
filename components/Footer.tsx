        ...
        <footer className="border-t border-gray-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700">
            <div>
                <div className="flex justify-center items-center mt-10">
                    <a href="https://github.com/vzekii" target="_blank" rel="noopener noreferrer" className="p-2 mx-1 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700" aria-label="Github">
                    ...
                    <a href="mailto:zach7505@gmail.com" target="_blank" className="p-2 mx-1 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700" aria-label="zach7505 (at) gmail (dot) com">
                        <EnvelopeIcon className="dark:text-white size-7" />
                    </a>
                    <a href="https://www.linkedin.com/in/zachclare/" target="_blank" rel="noopener noreferrer" className="p-2 mx-1 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700" aria-label="Github">
